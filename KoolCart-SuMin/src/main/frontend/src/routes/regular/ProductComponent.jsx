  ...
  return (
    <Box sx={{ display: 'flex', alignItems: 'center' }}>
      ...
      <Grid item xs={8} sx={{ display: 'flex', flexDirection: 'column', textAlign: 'left' }}>
        <Box sx={{ mt: 2 }}>
              <Typography variant='h6' gutterBottom>{regular.name}</Typography>
              <Typography variant='subtitle1' gutterBottom>{formattedPrice}원</Typography>
              <Typography variant='body2' gutterBottom>{regular.count}개</Typography>
              <Typography variant='body2' color="#32A4FF">{regular.cycle}일에 한 번</Typography>
        </Box>
      </Grid>
    </Box>
  );
