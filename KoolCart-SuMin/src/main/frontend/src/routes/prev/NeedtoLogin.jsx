...
const NeedtoLogin = ({switchToNotificationCenter}) => {
  ...
  return (
    ...
    >
      ...
      <h2 style={{fontSize:"5em"}}>Welcome to Smart Fridge</h2>
      <p style={{fontSize:"4em", fontWeight:"bold"}}>최초 로그인이 필요합니다.</p>
      <p style={{fontSize:"3em", fontWeight:"bold"}}>아래 버튼을 클릭하여 로그인 해주시기 바랍니다.</p>
